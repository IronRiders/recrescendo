...
public class RobotContainer {
        ...
        private void checkControl() {
                double average = (Math.abs(primaryController.getLeftY()) + Math.abs(primaryController.getLeftX())
                                + Math.abs(primaryController.getRightX())) / 3d;
        ...
        private void configureBindings() {
                driveSubsystem.setDefaultCommand(
                                Commands.parallel(robotCommands.driveTeleop(
                                                () -> Utils.controlCurve(
                ...
                primaryController
                                .x()
                                .onTrue(Commands.parallel(Commands.runOnce(() -> activeCommand.cancel()),
                                                robotCommands.reset()));
                ...
                primaryController
                                ...
                                .onTrue(
                                                robotCommands
                                                                .eject()
                                                                .unless(() -> !intakeSubsystem.hasNote())); // eject
                                                                                                            // unless we
                                                                                                            // don't
                                                                                                            // have a
                                                                                                            // note
