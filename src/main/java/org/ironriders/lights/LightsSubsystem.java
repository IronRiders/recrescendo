...
public class LightsSubsystem extends IronSubsystem {
  ...
  private final AddressableLEDBuffer buffer =
      new AddressableLEDBuffer(Constants.Lights.STRIP_LENGTH);
      ...
      case TRANS:
        pattern =
            LEDPattern.gradient(
                    ...
                    new Color("#FFFFFF"))
                .scrollAtAbsoluteSpeed(
                    MetersPerSecond.of(Constants.Lights.State.TRANS.scrollSpeed),
                    Constants.Lights.STRIP_DENSITY);
      ...
      case GAY:
        pattern =
            LEDPattern.gradient(
                    ...
                    new Color("#8E008E"))
                .scrollAtAbsoluteSpeed(
                    MetersPerSecond.of(Constants.Lights.State.GAY.scrollSpeed),
                    Constants.Lights.STRIP_DENSITY);
      ...
      case NONBINARY:
        pattern =
            LEDPattern.gradient(
                    ...
                    new Color("#2C2C2C"))
                .scrollAtAbsoluteSpeed(
                    MetersPerSecond.of(Constants.Lights.State.NONBINARY.scrollSpeed),
                    Constants.Lights.STRIP_DENSITY);
    }
